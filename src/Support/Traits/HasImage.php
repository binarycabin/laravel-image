...
namespace BinaryCabin\LaravelImage\Support\Traits;

trait HasImage{

    public function image(){
        return $this->morphOne(\BinaryCabin\LaravelImage\Models\Image::class, 'imageable');
    }
    ...
    public function storeImage($attributes = []){
        ...
        $image = \BinaryCabin\LaravelImage\Models\Image::attachAndCreate($data);
        return $image;
    }
